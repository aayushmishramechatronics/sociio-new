...
PRIMARY KEY (id),
KEY home_cities_relates_to_home_states (state_id),
CONSTRAINT home_cities_relates_to_home_states FOREIGN KEY (state_id) REFERENCES home_states (id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


INSERT INTO home_cities (id, city_name, state_id)
VALUES
(1,'Kolhapur',4),
(2,'Port Blair',5),
(3,'Adilabad',6),
